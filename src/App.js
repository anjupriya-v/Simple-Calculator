      ...
      if (this.state.operator_sign === "+") {
        ...
        if (this.value2 == "") {
          ...
          if (
            ...
            this.value2 = parseFloat(this.value2);
            this.setState({
              value: Math.floor(this.value1 / this.value2),
              assum: 1,
              operation: true,
            });
          } else {
        ...
        if (this.value2 == "") {
          ...
          if (
            ...
            this.value2 = parseFloat(this.value2);
            this.setState({
              value: Math.pow(this.value1, this.value2),
              assum: 1,
              operation: true,
            });
          } else {
    ...
    return (
      <div className="App">
        <Navbar
          ...
          operator_sign={this.state.operator_sign}
          secondValue={this.value2}
          result={this.state.value}
        />
        <h6 className="mainHeading" style={{ textAlign: "center" }}>
          Simple Calculator
        </h6>
              ...
              <table border="0">
                <tr>
                  <td>
                    <input
                      type="button"
                      className="square first allclear"
                      value="AC"
                      onClick={this.all_clear}
                    ></input>{" "}
                  </td>
                  <td>
                    <input
                      type="button"
                      className="square allclear"
                      value="CE"
                      onClick={this.clear_entry}
                    ></input>{" "}
                  </td>
                  <td>
                    <input
                ...
                <tr>
                  <td>
                    <input
                      type="button"
                      className="circle first point"
                      value="."
                      onClick={this.dis_point}
                    />{" "}
                  </td>
                  <td>
                    <input
